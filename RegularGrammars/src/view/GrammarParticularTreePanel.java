...
public class GrammarParticularTreePanel extends JPanel {
	...
	public GrammarParticularTreePanel(Node<String> node) {
		this.root = node;
	}
	...
	public void drawPartialTree(Graphics g, String [] valores, int y) {
		...
		g.setColor(Color.decode(ConstansGUI.GREEN_BUTTON_COLOR));
	...
	public void refreshPartialTree(Node<String> newRoot, String rute) {
		this.root = newRoot;
		this.x = rute;
		repaint();
		revalidate();
