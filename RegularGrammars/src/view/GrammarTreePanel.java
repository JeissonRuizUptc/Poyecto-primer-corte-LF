...
public class GrammarTreePanel extends JPanel{
	...
	public GrammarTreePanel(Node<String> node) {
		root = node;
	}
	...
	public void paint(Graphics g) {
		...
		if (root != null) {
	        g2d.setColor(Color.decode(ConstansGUI.RED_BUTTON_COLOR));
	...
	public void drawChilds(Graphics g2d , Node<String> node , int minX , int xSize , int y, int originX , int originY, String[] total) {
		g2d.setColor(Color.decode(ConstansGUI.PURPLE_COLOR));
	...
	public void refreshTree(Node<String> newRoot , String route) {
		root = newRoot;
		totalRoute = route ;
		repaint();
		revalidate();
