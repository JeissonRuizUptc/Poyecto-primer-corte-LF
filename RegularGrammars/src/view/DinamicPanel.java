...
public class DinamicPanel extends JPanel{
	...
	public DinamicPanel(ActionListener listener) {
		...
		grammarBtn.setBackground(Color.decode(ConstansGUI.GREEN_BUTTON_COLOR));
		...
		validationBtn.setBackground(Color.decode(ConstansGUI.GREEN_BUTTON_COLOR));
		...
		particularTreeBtn.setBackground(Color.decode(ConstansGUI.GREEN_BUTTON_COLOR));
		...
		buttonsPanel.setBackground(Color.decode(ConstansGUI.BLUE_COLOR));
	...
	public void changeContainer (Node<String> node, String route) {
